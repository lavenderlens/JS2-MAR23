...
var _paragraph = require("./components/Paragraph"); //default export - no curlies
...
onload = ()=>{
    document.body.appendChild((0, _h2.H2)("Weekly forecast"));
    ...
    let labelGroupLat = (0, _.$)("label", "latitude: ", {
        id: "latLabel",
        for: "lat"
    }, [
        (0, _.$)("input", null, {
    ...
    let labelGroupLon = (0, _.$)("label", "longitude: ", {
        id: "lonLabel",
        for: "lon"
    }, [
        (0, _.$)("input", null, {
    ...
    let searchButton = (0, _.$)("button", "GET FORECAST", {
        type: "button",
        id: "find-weather"
    });
    ...
    function findWeather() {
        ...
        (0, _axiosDefault.default).get(connectionString)// .then((response) => console.log(response.data)) //this is where we do our async work
        .then((response)=>main.appendChild((0, _weatherTable.WeatherTable)(response.data))) //this is where we do our async work
...
},{"./components/Paragraph":"gZS5y","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./components/H2":"daFZn","axios":"jo6P5","./components/$":"kKekq","./components/WeatherTable":"6NyDF"}],"gZS5y":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _paragraphCss = require("./Paragraph.css");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./Paragraph.css":"57U0P"}],"gkKU3":[function(require,module,exports) {
...
},{}],"57U0P":[function() {},{}],"daFZn":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var Buffer = require("78519b2fe3d7cbc4").Buffer;
"use strict";
/**
...
},{"78519b2fe3d7cbc4":"fCgem","../utils.js":"5By4s","../core/AxiosError.js":"3u8Tl","../platform/node/classes/FormData.js":"aFlee","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fCgem":[function(require,module,exports) {
/*!
...
var base64 = require("a7baa1845fe2bdcb");
var ieee754 = require("98ff3d456f6bceb6");
...
},{"a7baa1845fe2bdcb":"eIiSV","98ff3d456f6bceb6":"cO95r"}],"eIiSV":[function(require,module,exports) {
"use strict";
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "WeatherTable", ()=>WeatherTable);
var _ = require("./$");
const WeatherTable = (weather)=>{
    ...
    let tdLatLon = (0, _.$)("th", `search for lat: ${weather.lat} lon: ${weather.lon}`, {
        colspan: 4
    });
    let tdTimeZone = (0, _.$)("th", `timezone: ${weather.timezone}`, {
        colspan: 4
    });
    ...
    for(let i = 0; i < weather.daily.length; i++){
        //append DAY to row 2
        tr2.appendChild((0, _.$)("td", `${calcDay(weather, i)}`));
        //append desciption to row 3
        tr3.appendChild((0, _.$)("td", `${weather.daily[i].weather[0].description}`));
    }
...
},{"./$":"kKekq","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["jC2qd","8lqZg"], "8lqZg", "parcelRequire6256")
